  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black">Live AI SLA + eval gate</h1>
        <p className="mt-2 text-slate-600">OpenAI vision/text/chat élő bekötés, guardrail, trace és AI eval suite amerikai szintű kontrollja.</p>
      </div>
