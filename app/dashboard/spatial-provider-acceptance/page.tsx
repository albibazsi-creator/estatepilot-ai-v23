...
export default function Page() {
  const data = getSpatialProviderAcceptanceGate();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black">3D provider acceptance gate</h1>
        <p className="mt-2 text-slate-600">Gaussian Splatting / digital twin provider output, scene manifest, QA és viewer deploy kritériumok.</p>
      </div>
