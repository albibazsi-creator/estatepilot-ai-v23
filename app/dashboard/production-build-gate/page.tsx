...
export default function Page() {
  const data = getProductionBuildProofGate();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black">Production build proof gate</h1>
        <p className="mt-2 text-slate-600">A cél, hogy ne csak ZIP legyen, hanem bizonyítottan buildelhető, seedelhető, futtatható pilot.</p>
      </div>
