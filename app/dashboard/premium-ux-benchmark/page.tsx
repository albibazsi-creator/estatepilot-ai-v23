...
import { getPremiumUxBenchmarkGate } from "@/lib/v22-american-grade";
...
export default function Page() {
  const data = getPremiumUxBenchmarkGate();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black">Premium UX benchmark</h1>
        <p className="mt-2 text-slate-600">Zillow/Matterport-szerű 2 perces wow-flow és mobil-first public listing audit.</p>
      </div>
