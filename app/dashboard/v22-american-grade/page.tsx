...
export default function Page() {
  const data = getV22AmericanGradeReadiness();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black">V22 American-grade launch hardening</h1>
        <p className="mt-2 text-slate-600">A hat amerikai-szintű start gate összesítése: build proof, live AI, 3D provider acceptance, premium UX, CRM QA és provider certification.</p>
      </div>
