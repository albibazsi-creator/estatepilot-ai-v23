...
export default function Page() {
  const data = getCrmRevenueAutomationQaGate();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-black">CRM revenue automation QA</h1>
        <p className="mt-2 text-slate-600">Leadből sales action, deal pipeline, seller activity és follow-up automatizmus minőségkapuja.</p>
      </div>
